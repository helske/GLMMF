...
Rcpp::List smoother(Rcpp::NumericMatrix y_, Rcpp::NumericVector Z_, Rcpp::NumericMatrix u_,
Rcpp::NumericVector a1_, Rcpp::NumericMatrix P1_, Rcpp::NumericMatrix P1inf_, const int dist,
